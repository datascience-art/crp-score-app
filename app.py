...
CATEGORIAS = sorted([
    "arte","astrologia","ciencia","clima","cultura","deportes","economia",
    "espectaculos","espectáculos","gastronomia","humor","moda","musica",
    "negocios","psicologia","salud y bienestar","sociedad","tecnologia"
])
SUBCATS = sorted([
    "adivinanza","analisis","anecdota","anuncio","baile","behind the scenes",
    "celebracion","clip musical","comunicado oficial","concierto","concurso",
    "cronica","dato curioso","debut","entretenimiento","evento","fotografia",
    "historia","homenaje","humor","interes humano","meet and greet","meme",
    "noticia","noticia viral","opinion","podcast","premiacion","presentacion",
    "programa","promocion","ranking","recomendacion","reportaje","resumen",
    "sorteo","tutorial","videoclip","viral"
])
TONOS_EMO = sorted([
    "admiracion","alegria","amor","celebratorio","confianza","curiosidad",
    "empoderamiento","entusiasmo","gratitud","humor","indignacion","inspiracion",
    "melancolia","nostalgia","orgullo","serenidad","sorpresa","ternura","tristeza"
])
ESTILOS = sorted([
    "celebratorio","conversacional","critico","descriptivo","didactico",
    "emotivo","humoristico","informativo","inspirador","narrativo",
    "opinativo","persuasivo","publicitario","sarcastico"
])
SITUACIONES = sorted([
    "no aplica","actividad recreativa","actuacion","alfombra roja","anecdota",
    "anuncio","behind the scenes","celebracion","concierto","encuentro",
    "ensayo","evento","homenaje","interaccion social","interacción social",
    "meet and greet","premiacion","presentacion de disco","programa en directo",
    "sesion de fotos","tour promocional","videoclip","visita"
])
TIPOS_CTA = sorted([
    "no aplica","aplaudir","asistir","ayudar","celebrar","comentar","comprar",
    "etiquetar","participar","registrarse","seguir","sintonizar",
    "subir contenido","visitar","votar"
])
TIPOS_ENLACE = sorted([
    "no aplica","app store","articulo web","evento","facebook","instagram",
    "sitio oficial","tienda online","youtube"
])
TIPOS_HUMOR = sorted([
    "no aplica","doble sentido","humor absurdo","humor blanco","humor fisico",
    "humor situacional","juegos de palabras","memes","parodia","sarcasmo"
])
EMOCIONES_SEC = sorted([
    "no aplica","admiracion","amor","curiosidad","empoderamiento","entusiasmo",
    "gratitud","humor","indignacion","inspiracion","melancolia","orgullo",
    "satisfaccion","serenidad","sorpresa","ternura"
])
        ...
        with st.form("form_t2", clear_on_submit=True):
            ...
            with st.expander("Opcionales"):
                ...
                with cc2:
                    ...
                    ce2  = st.text_input("Celebridad", value="no aplica", key="t2ce")
                with cc3:
